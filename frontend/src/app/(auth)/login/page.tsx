        ...
        {tab === 'email' && (
          <form onSubmit={emailForm.handleSubmit(onEmailLogin)} className="space-y-4">
            ...
            <div>
              ...
              <input {...emailForm.register('password')} type="password" placeholder="••••••••" className="w-full px-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" />
            </div>
